...
const STEPS = [
  ...
  },
  {
    ...
    icon: "🎯",
    title: "Training",
    text: "Trained on 65,000 histopathology patches across 15 epochs using MobileNetV2 transfer learning with frozen base layers, Adam optimizer, and binary crossentropy loss",
  },
  {
    n: "05",
    icon: "🚀",
