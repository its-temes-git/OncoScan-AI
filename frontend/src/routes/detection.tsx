          ...
          <motion.aside initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2 }} className="lg:col-span-2 space-y-6">
            ...
            <div className="glass rounded-2xl p-6">
              ...
              <dl className="space-y-2 text-sm">
                ...
                <div className="flex justify-between"><dt className="text-muted-foreground">Accuracy</dt><dd className="font-semibold text-navy">80.53%</dd></div>
                <div className="flex justify-between"><dt className="text-muted-foreground">AUC Score</dt><dd className="font-semibold text-navy">88.33%</dd></div>
